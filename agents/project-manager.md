...
6. Update `$vault/projects/<owner>/<repo>.md` (create if absent, update `last_synced` and tables).
7. After GitHub mutations, optionally run `bash ~/.config/opencode/skills/vault-gc/gc.sh`.
