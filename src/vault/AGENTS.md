...
2. The audit is performed, usually with the help of @auto-auditor, though sometimes manually. An audit is produced in the vault.
...
| `@auto-auditor` | Structured audit agent, analagous to @planner. Tool detection, static analysis, vault report |
